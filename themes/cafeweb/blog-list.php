<article class="blog_article">
    ...
    <header>
        <p class="meta"><a title="Artihogos em <?= $post->category()->title; ?>" href="<?= url("/blog/em/{$post->category()->uri}"); ?>"><?= $post->category()->title; ?></a>&bull;<?= "{$post->author()->first_name} {$post->author()->last_name}" ?> &bull; <?= date_fmt($post->post_at) ?></p>
