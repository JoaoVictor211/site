    ...
    <?php if (empty($blog) && !empty($search)) : ?>
        <div class="content content">
            <div class="empty_content">
                ...
                <p class="empty_content_desc">Você pesquisou por <span><?= $search ?></span>, tente outros termos</p>
                <a title="Blog" class="empty_content_btn gradient gradient-green gradient-hover radius" href="<?= url("/blog"); ?>">...ou volte ao blog</a>
            </div>
        </div>
